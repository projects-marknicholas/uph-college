...
const External = ({ application, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(application.scholarship_type_id);
      console.log(application.type_id);
      ...
      <div className="entrance-application">
        <div className="content">
          <div className="headers">
            ...
            <h3 style={{ textTransform: 'uppercase' }}>{application.type} APPLICATION FORM</h3>
          </div>
          ...
          <div className="privacy">
            ...
            /> 
            <span>
              By signing this <b>{application.type} application form</b>, you hereby
