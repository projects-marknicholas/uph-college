        ...
        <div className='closing'>
          ...
          <div className="content">
            <div className="headers">
              ...
              <h3 style={{ textTransform: 'uppercase' }}>{application.form_type} APPLICATION FORM</h3>
            </div>
            ...
            <div className="privacy">
              "By signing this <b>{application.form_type} application form</b> you  hereby allow / authorize UPH Calamba
