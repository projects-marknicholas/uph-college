...
const PerpetualiteArchives = ({ application, onClose }) => {
        ...
        <div className='closing'>
          ...
          <div className="content">
            <div className="headers">
              ...
              <h3>THE PERPETUAL ARCHIVES APPLICATION FORM</h3>
            </div>
            ...
            <div className="privacy">
              "By signing this <b>the perpetual archives application form</b> you  hereby allow / authorize UPH Calamba
...
export default PerpetualiteArchives;