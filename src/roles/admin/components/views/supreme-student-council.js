...
const SupremeStudentCouncil = ({ application, onClose }) => {
        ...
        <div className='closing'>
          ...
          <div className="content">
            ...
            <div className="privacy">
              "By signing this <b>ssc scholars application form</b> you  hereby allow / authorize UPH Calamba
...
export default SupremeStudentCouncil;