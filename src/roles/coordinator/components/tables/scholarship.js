...
import ViewApplication from "../forms/application";

// API
import { getTypes } from "../../../../api/adviser";

// CSS
import '../../../../assets/css/table.css';

const TableScholarship = () => {
                  ...
                  <tr key={index}>
                    ...
                    <td className="action-field">
                      <button className="view" onClick={() => handleViewApplication(row)}>
                        <img src={ViewSvg} alt="View" /> Apply
                      </button>
                    </td>
                  </tr>
                ))
...
export default TableScholarship;
