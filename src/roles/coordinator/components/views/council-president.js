...
const CouncilPresidents = ({ application, onClose }) => {
        ...
        <div className='closing'>
          ...
          <div className="content">
            <div className="headers">
              ...
              <h3>COLLEGE COUNCIL PRESIDENTS APPLICATION FORM</h3>
            </div>
            ...
            <div className="privacy">
              "By signing this <b>college council president application form</b> you  hereby allow / authorize UPH Calamba
...
export default CouncilPresidents;