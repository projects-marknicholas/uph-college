...
const PresidentialBoardDirectorScholar = ({ studentTypeId, typeId }) => {
      ...
      <div className="entrance-application">
        <div className="content">
          <div className="headers">
            ...
            <h3>PRESIDENTIAL/BOARD DIRECTOR SCHOLAR APPLICATION FORM</h3>
          </div>
...
export default PresidentialBoardDirectorScholar;
